...
echo
	...
	git clone https://github.com/Technopig100/archlis.git $buildFolder/archiso/airootfs/archlis
...
echo
	...
	FIND='livecd-sound'
	REPLACE='  ["/archlis/start.sh"]="0:0:755"'
	...
	cp archlis 	$buildFolder/archiso/airootfs/usr/bin

	FIND='livecd-sound'
	REPLACE='  ["/usr/bin/archlis"]="0:0:755"'
	find $buildFolder/archiso/profiledef.sh -type f -exec sed -i "/$FIND/a $REPLACE" {} \;
